...
public class Pessoa implements Serializable {
     ...
     public Set<PerfilEnum> getPerfis() { return perfis.stream().map(perfis -> PerfilEnum.toEnum(perfis)).collect(Collectors.toSet()); }

     public void addPerfil(PerfilEnum perfil) { this.perfis.add(perfil.getCodigo()); }
